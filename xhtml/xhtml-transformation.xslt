<xsl:stylesheet version = '2.0' xmlns:xsl='http://www.w3.org/1999/XSL/Transform'>
    ...
    <xsl:template match='/'>
        <xsl:apply-templates select='country_fact_document/country' mode='file' />
        <xsl:result-document href='index.html'>
            <html>
                ...
                <body>
                  <section class='index'>
                    <div class="container-fluid bg-1 index">
                      <h1 class="margin">Country Factbook index</h1>
                        <ul class="nav navbar-nav navbar-left">
                          <xsl:apply-templates select='country_fact_document/country' mode='index'/>
                        </ul>
                    </div>
                  </section>
                  <!-- Footer -->
    ...
    <xsl:template match='country' mode='index'>
      <li>
        <a href='{@id}.html'>
            <h2 class="margin"><xsl:value-of select='name'/></h2>
            <div class="index_img">
              <xsl:element name="img">
                <xsl:attribute name="src">../<xsl:value-of select="images/image[1]"/></xsl:attribute>
              </xsl:element>
            </div>
              ...
              <body>
                ...
                <div class="container">
                  <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">xHTML output of countries</a>
                  </div>
